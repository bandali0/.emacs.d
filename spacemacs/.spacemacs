...
values."
  (setq-default
   ...
   '(
     beacon                             ; Highlight cursor position in buffer
     )
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '((tango-plus :location (recipe :fetcher github
                                                       :repo "aminb/tango-plus-theme"))
                         spacemacs-dark
                         spacemacs-light)
